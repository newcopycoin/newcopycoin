...
private slots:
    ...
    QString BuyCPY(QString OrderType, double Quantity, double Rate);
    QString SellCPY(QString OrderType, double Quantity, double Rate);
