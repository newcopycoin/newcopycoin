...
private slots:
    ...
    QString BuyNMS(QString OrderType, double Quantity, double Rate);
    QString SellNMS(QString OrderType, double Quantity, double Rate);
