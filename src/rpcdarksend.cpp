...
Value masternode(const Array& params, bool fHelp)
{
    ...
    if (fHelp  ||
        ...
        throw runtime_error(
                ...
                "  stop         - Stop masternode configured in numus.conf\n"
                ...
                "  vote         - Vote on a Numus initiative\n"
                );
    ...
    if (strCommand == "genkey")
    {
        ...
        return CNumuscoinSecret(secret).ToString();
    }
...
Value masternodelist(const Array& params, bool fHelp)
{
                ...
                && strMode != "pubkey" && strMode != "rank" && strMode != "status" && strMode != "addr" && strMode != "votes" && strMode != "lastpaid"))
    {
        throw runtime_error(
                ...
                "  votes          - Print all masternode votes for a Numus initiative (can be additionally filtered, partial match)\n"
